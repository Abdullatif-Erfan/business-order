				  ...
				  <div class="card">
					...
					<div class="card-body"><!-- card-body -->
                       ...
                       <?php
                        ...
                        ?>
					 <!-- form start -->
                     <?php  $attribute = array('name'=>'add_form');  echo form_open_multipart('management/user/addNewUser', array('id' => 'img')); ?>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-4">    
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" name="fname" minlength="5" maxlength="128" required>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control"  name="password" id="password" minlength="6" maxlength="20" autocomplete="new-password" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                        ...
                        <div class="box-footer m-t-10 m-r-10">
                            <input type="submit" class="btn btn-primary" value="ثبت کاربر جدید" />
