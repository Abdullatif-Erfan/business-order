...
<?php $this->load->view('old_journals/scripts.php'); ?>
<!--  main content -->
		   ...
		   <div class="content">
			  <div class="page-inner">
		    	...
		    	<div class="col-md-12 col-sm-12 col-xs-12 m-t--10">
				  <div class="card">
					<div class="card-header" style="padding: 11px 20px !important; display:inline !important">
			
					   <!-- <h4 style="display:inline !important">لیست ژورنال سابقه</h4> -->
						
					   <a href="<?php echo base_url(); ?>oldJournalAddForm">
								<button type="button" class="btn btn-sm mybtn">
									<i class="fas fa-plus"></i> ثبت  بیلانس افتتاحیه
								</button>
						</a>
						...
						<a href="<?=base_url()."journals"?>" class="pull-left">
							<button type="button" class="btn btn-sm mybtn" >
							...
							<div class="row">
								...
								<div class="col-md-2 col-sm-6 col-xs-6">
                                        ...
                                        <span class="input-group-text" style="width:40px !important;" data-mddatetimepicker="true" data-trigger="click"
                                            ...
                                            <input class="form-control"  name="pay_date" id="start_date"  
