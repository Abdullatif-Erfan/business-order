			  ...
			  <!-- breadcrum -->
				<div class="page-header m-t--10">
					<ul class="breadcrumbs">
						...
						<li class="nav-item">
						 <a href="<?php echo base_url(); ?>salary">لیست  معاشات</a>
						</li>
					</ul>
				</div>
				<!-- /breadcrum -->
		        ...
		        <!-- insertion -->
			          <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <?php   echo form_open_multipart('salary/salary/update'); ?>
                        <input  value="<?=$journal[1]['id']?>" type="hidden"  name="first_id" >
                         <input  value="<?=$journal[0]['id']?>" type="hidden"  name="second_id" >
                         <input  value="<?=$journal[0]['customer_id']?>" type="hidden"  name="customer_id" >
                         <input  value="<?=$journal[1]['account_id']?>" type="hidden"  name="from_account_id" >
