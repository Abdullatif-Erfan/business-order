     ...
     <div class="box-tools m-t-10"> <a class="text-dark collapsed" data-toggle="collapse"
	  href="#add_unit" aria-expanded="false">
			...
			<div id="add_unit" class="add-form animated fadeInRight collapse" data-parent="#accordion" style="height: 0px;border-top:2px solid #89b4ea;" aria-expanded="false">
				<div class="box-body">
				...
				<div class="form-body">
					<div class="row">
						...
						<div class="col-md-10 col-sm-10 col-xs-10">
						  <div class="form-group form-floating-label">
							...
							<input class="form-control input-solid" id="name" name="name" type="text" required>
								<label for="name" class="placeholder">نام واحد را بنویسید</label>
						...
						<!-- <div class="col-md-5 col-sm-5 col-xs-10">
						  <div class="form-group form-floating-label">
								<select  class="form-control select2 " style="width: 100%; border:none !important; background-color:#ddd;" aria-hidden="true" name="status" > 
									<option value=""> قابل استفاده دربخش  ؟ </option>
										<option value="1">خرید دوا</option>
										<option value="2">خرید عمومی</option>
								</select> 
