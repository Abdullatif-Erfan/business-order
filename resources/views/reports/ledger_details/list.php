...
$this->load->view('reports/ledger_details/scripts.php');
 ?>
<!--  main content -->
		<div class="main-panel">
		   <div class="content">
			  <div class="page-inner">
				<div class="row">
			    <input type="hidden" id="default_account_id" value="<?=$cur_account_id?>" >
			    <input type="hidden" id="default_currency_id" value="<?php echo $this->uri->segment(3); ?>" >

		    	<div class="col-md-12 col-sm-12 col-xs-12 m-t-10">
				  <div class="card">
					<div class="card-header" style="padding: 11px 20px !important;">
					     <span><?=" حساب ".$account_name.' -  پول '.$currency_name?></span>
						     <a href="<?=base_url().'reports/balancesheet'?>">
								<button type="button" class="btn btn-sm mybtn m-l-10 pull-left">
								رفتن به بیلانس شیت &nbsp; <i class="fas fa-arrow-left"></i>  
								</button>
							</a>

							<a href="<?=base_url().'journals'?>">
								<button type="button" class="btn btn-sm mybtn m-l-10 pull-left">
								رفتن به روزنامچه  &nbsp;<i class="fas fa-arrow-left"> </i>  
								</button>
							</a>
					</div>


					<?php $this->load->view('reports/ledger_details/search.php'); ?>	
							...
							<thead>
							  <tr class="d-none" style="width:100%; background-color:#fff !important;color:#000 !important;">
								...
								<tr class="d-none" style="width:100%; background-color:#fff !important;color:#000 !important;">
									<td colspan="11">
										<center>
								        <h3 style="margin-top:10px"><?=" حساب ".$account_name.' -  پول '.$currency_name?></h3>
									     </center>
								     </td>
								</tr>
								<tr>
