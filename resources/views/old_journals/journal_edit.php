		    	...
		    	<div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="card-header" style="padding: 10px;">
                        ...
                        <div class="box-body animated fadeInRight" style="border-top:2px solid #89b4ea;">
                         ...
                         echo form_open('oldJournalUpdate',$attributes); ?>
                         ...
                         <div class="row" style="padding: 10px 20px;">
                          ...
                          <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control input-solid" step="0.01"  name="amount"  id="amount" placeholder="مبلغ به عدد" required value="<?=$journal[0]['amount']?>">  
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group form-floating-label">
                                    ...
                                    <select  class="form-control select2 " style="width: 100%; border:none !important; background-color:#ddd;" aria-hidden="true" name="currency_id" id="currency_id" onchange="getPayerBalance(this.value)" required>
                              ...
                              <div class="form-group">
                                <label for=""> انتخاب گزینه </label>
                                    <select  class="form-control select2 " style="width: 100%; border:none !important; background-color:#ddd;" aria-hidden="true" name="transaction_type" id="transaction_type" required> 
                                       <option value="<?=$journal[0]['transaction_type']?>"> <?= intval($journal[0]['transaction_type']) === 1 ? "  بردگی  ": "  رسیدگی " ?> </option>  
                            ...
                            <!-- <div class="col-md-4 col-sm-6 col-xs-12">
                              <div class="form-group">
                                <label for=""> انتخاب گزینه </label>
                                    ...
                                    <option value="<?=$journal[0]['payment_type']?>"> <?php  
                                    if(intval($journal[0]['payment_type']) === 1) { echo "  نقد  "; } 
                                    else if(intval($journal[0]['payment_type']) === 2) { echo  "  قرض "; } 
                                    else {  echo "طلب"; } ?> 
                                    </option>   
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                ...
                                <input type="text" class="form-control input-solid" name="details"  
                                id="details" value="<?=$journal[0]['details']?>" required>  
                            </div>
                         </div>
