    ...
    <div class="col-xs-12">
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                ...
                <input type="text" class="form-control" name="name" required placeholder="{{ __('currency.name_placeholder') }}">
                <span id="currencyNameError" class="text-danger"></span>
            </div>

            <div class="form-group col-sm-6">
                <label for="symbols">{{ __('currency.symbol_label') }}</label>
                <input type="text" class="form-control" name="symbols" required placeholder="{{ __('currency.symbol_placeholder') }}">
                <span id="symbolsError" class="text-danger"></span>
            </div>

            <div class="form-group col-sm-12">
                <label for="color">{{ __('currency.color_label') }}</label>
                <input type="color" class="form-control" name="color" placeholder="{{ __('currency.color_placeholder') }}" style="height: 30px !important;">
