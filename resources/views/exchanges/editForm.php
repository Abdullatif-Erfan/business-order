		    	...
		    	<div class="col-md-12 col-sm-12 col-xs-12">
				  <div class="card" style="min-height: 400px"> 
                    <div class="card-header" style="padding: 10px;">
                        <h4 class="card-title">  تبادله اسعار 
                        ...
                        <?php $attributes = array('role' => 'form', 'autocomplete' => 'off');
                         echo form_open('updateExchangeRates',$attributes); ?>
						 <input type="hidden" id="cur_amount" >
						 <input type="hidden" value="<?=$journal[1]['id']?>" name="first_id" >
						 <input type="hidden" value="<?=$journal[0]['id']?>" name="second_id" >
                       ...
                       <div class="form-body">
						...
						<div class="col-md-4 col-sm-6 col-xs-12">
						 <label>مبلغ فروش</label>
						   <div class="form-group form-floating-label">
							<input class="form-control " id="from_amount" name="from_amount" type="text" step="0.01" placeholder="به  عدد" value="<?=$journal[1]['amount']?>"  required >
						   </div> 
						</div>	
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
						  <label>نرخ روز</label>
						   <div class="form-group form-floating-label">
							...
							placeholder="به عدد" onkeyup="CalculateCusterAmountBasedOnUpdatedRate()" 
							value="<?=$journal[0]['rate']?>"
							 required>
						   </div> 
						</div>	
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
						  <label>مبلغ قابل پرداخت مشتری</label>
						   <div class="form-group">
							<input class="form-control" id="to_amount"  name="to_amount" type="text" step="0.01" 
							value="<?=$journal[0]['amount']?>"
							placeholder="به عدد"  >
						   </div> 
						</div>	
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                             <label>مفاد</label>
						     <div class="form-group">
							   <input class="form-control"  id="profit" value="<?=$journal[0]['profit']?>"  name="profit" type="number" step="0.0001" >
						    </div> 
						</div>	
