<form id="orgProfileEditForm">
   @csrf
    ...
    <div class="form-group">
        ...
        @if ($orgBio->header)
            <img id="headerPreview" src="{{ Storage::url($orgBio->header) }}" alt="Header Image" class="img-thumbnail mt-2">
        @else
    ...
    <div class="form-group">
        ...
        @if ($orgBio->logos)
            <img id="logoPreview" src="{{ Storage::url($orgBio->logos) }}" alt="Logo Image" width="150" class="img-thumbnail mt-2">
        @else
