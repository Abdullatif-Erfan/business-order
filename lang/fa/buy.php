...
return [
    ...
    'invoice_generated' => 'فاکتور ایجاد شده',
    'select_at_least_one' => 'لطفاً حداقل یک مورد را انتخاب کنید',
    'confirm_generate_invoice' => 'آیا از ایجاد فاکتور برای موارد انتخاب شده اطمینان دارید؟',
    'invoice_generated_successfully' => 'فاکتور با موفقیت ایجاد شد',
    'invoice_details' => 'جزئیات فاکتور',
    'payment_added_successfully' => 'پرداخت با موفقیت ثبت شد',
    'different_suppliers' => 'موارد انتخاب شده متعلق به تامین کننده‌های مختلف هستند',
