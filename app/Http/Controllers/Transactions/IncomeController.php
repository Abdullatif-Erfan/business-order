...
class IncomeController extends Controller
{
     ...
     * status:  1: old income, 2: income, 3:income, 4:expense, 5:salary, 6:participants, 7:buy, 8:sales, 9:other
     */
    ...
    public function details(Request $request, $times)
    {
        ...
        return view('transactions.income.details',compact('journals'));
    ...
    public function edit(string $id)
    {
        ...
        return view('transactions.income.edit',compact('accounts','currencies','branchs','income','incomeTypes'));
    }
