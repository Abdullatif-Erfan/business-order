...
*/
var print_title = document.getElementById('print_title').innerHTML;
(function(c) {
    ...
    k.ext.buttons.print = {
        ...
        text: function(b) 
        {
            return b.i18n("buttons.print", "<i class='fa fa-print'></i>")
        },
        action: function(b, a, d, g) {
            ...
            f.document.body.innerHTML = "" + d.title + "<div>" + (d.messageTop || "") + "</div>" + h + "<div>" + (d.messageBottom || "") + "</div>";
        ...
        // title: "*",
        // title: print_title,
        title: "<img src='http://localhost/design_center/assets/images/banner4.jpg' class='print_img img-responsive' style='width:99.7%;min-height:115px;margin-bottom:-12px;'><div class='col-md-12 col-sm-12 col-xs-12' style='position:absolute;top:6px;height:auto;font-size:15px;'>"+print_title+"</div>",
