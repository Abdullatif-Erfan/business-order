        ...
        if ($request->ajax()) {
            ...
            return DataTables::eloquent($orgBio)
                ...
                ->addColumn('header', function ($orgBio) {
                    if ($orgBio->header) {
                        return '<img src="' . Storage::url($orgBio->header) . '" width="50" height="50" class="img-thumbnail">';
                    }
                    return 'No Image';
                })
                ->addColumn('logos', function ($orgBio) {
                    if ($orgBio->logos) {
                        return '<img src="' . Storage::url($orgBio->logos) . '" width="50" height="50" class="img-thumbnail">';
                    }
                    return 'No Image';
                })
