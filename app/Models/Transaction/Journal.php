...
{
    protected $fillable = ['code','bill_no','account_type_id','account_id','amount','currency_id','transaction_type','payment_type','options','user_name','user_id','category_id','car_id','idate','year','month','doc','details','status','dynamic_type','dt_comment','times'];
