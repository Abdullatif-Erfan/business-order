                     ...
                     foreach($store as $key => $value){ ?>
                        <tr>
                            ...
                            <td>
                             ...
                             <td> 
                                <a href="#">
							         <i class="fas fa-pen-square" data-toggle="modal" data-target="#stor_modal<?php echo $id2; ?>" style="font-size:20px;" alt="ویرایش"></i>
                                   </a> 
                                   <!-- modal -->
                                     <div id="stor_modal<?php echo $id2; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
