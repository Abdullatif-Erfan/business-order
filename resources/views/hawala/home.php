...
<?php $this->load->view('transactions/scripts.php'); ?>
<!--  main content -->
		    	...
		    	<div class="col-md-12 col-sm-12 col-xs-12 m-t--10">
				  <div class="card">
					<div class="card-header" style="padding: 11px 20px !important;">
						...
						<?php if(is_admin()) { ?>
							<a href="<?php echo base_url(); ?>transactionOutAddForm">
								<button type="button" class="btn btn-sm mybtn">
									<i class="fas fa-arrow-alt-circle-up"></i> ثبت حواله رفت
								</button>
							</a>

							<a href="<?php echo base_url(); ?>oldJournalList">
								<button type="button" class="btn btn-sm mybtn m-r-10">
									<i class="fa fa-arrow-alt-circle-down"></i> ثبت حواله آمد
								</button>
							</a>
