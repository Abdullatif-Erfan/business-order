     ...
     <div class="table-responsive table_responsive" style="padding:5px;">
        <table id="example5" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    <?php $id=1; $id2=40; foreach($account_type as $key => $value){ ?>
                        <tr>
                            <td><?php echo $id; ?></td>
                            <td>
                            ...
                            <?php echo $value['name']; ?></td>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                   <div class="form-group form-floating-label">
                                                    ...
                                                    <label for="name" class="placeholder"> نوع صورت حساب  </label>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group form-floating-label">
                                                            <select class="form-control"  name="is_need_details">
                                                              <option value="<?php echo $value['is_need_details']; ?>"><?php echo $value['is_need_details'] == 1 ? "بلی":"نخیر"; ?></option>
                             ...
                             <td>
                             <?php 
                                if(doesHaveAccessTo('settings','delete_records')) {
                                 ?>
                                <!-- <a href="<?php echo base_url(); ?>settings/setting/delete_account_type/<?php echo $this->my_encryption->do_encode($value['id']); ?>">
