                                ...
                                <div class="form-body" style="padding: 0px 0px 15px !important;">
                                    <div class="row" style="padding: 10px 20px;">
                                       ...
                                       <div class="col-md-3 col-sm-4 col-xs-6">
                                        ...
                                        <select class="form-control select2" style="width: 100%; background-color:#ddd;" name="customer_account_id" id="customer_account_id" onchange="getBalance(this.value)" required>
                                            ...
                                            <div class="row">
                                                <table class="table table-bordered summary-table" style="background-color:#f6f6f6;">
                                                    <tr>
                                                        ...
                                                        <td style="width:15%">
                                                            <input type="number" name="cur_pay" id="cur_pay" value="0" oninput="updateRemainOnCurPay(this.value)" class="form-control" step="any" required>
                                                            <small style="font-size:10px; border:1px solid #ddd; border-radius:10px;padding: 2px 5px;">
                                                                  بیلانس فعلی  : 
