...
class BoughtDetailsBasedItemController extends Controller
{
    ...
    public function getData(Request $request)
    {
            ...
            //     $boughtItems->whereBetween('bought_item_relation.idate', [$request->start_date, $request->end_date]);
            // } elseif ($request->start_date) {
            //     $boughtItems->whereDate('bought_item_relation.idate', '=', $request->start_date);
            // } elseif ($request->end_date) {
            //     $boughtItems->whereDate('bought_item_relation.idate', '<=', $request->end_date); // Until today
            // }
