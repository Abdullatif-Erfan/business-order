				  ...
				  <div class="card" style="min-height: 400px"> 
                    <div class="card-header" style="padding: 10px;">
                        ...
                        <?php $attributes = array('role' => 'form', 'autocomplete' => 'off');
                         echo form_open_multipart('updateBothJournals',$attributes); ?>
                         <input  value="<?=$journal[0]['id']?>" type="hidden"  name="first_id" >
                         <input  value="<?=$journal[1]['id']?>" type="hidden"  name="second_id" >
                         <input type="hidden" id="cur_balance" value="">
                         <input type="hidden" id="from_currency_id" value="<?=$journal[0]['currency']?>" >
                         <input type="hidden" name="times" value="<?=$journal[0]['times']?>" >
                         <input type="hidden" name="code" value="<?=$journal[0]['code']?>" >
                         ...
                         <div class="row" style="padding: 10px 20px;margin-top:10px;">
                          ...
                          <?php
                           //   Show Form Validation Error
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group form-floating-label"> 
                                    ...
                                    onchange="selectAccountsLabel(this.value)" > 
                                       <option value="<?=$journal[1]['options']?>">
                                        <?php if(intval($journal[1]['options']) === 1) { echo 'معاملات نقد به نقد'; } 
                                        else if(intval($journal[1]['options']) === 2)  { echo "معاملات نسیه به نسیه"; } 
                                        else if(intval($journal[1]['options']) === 3)  { echo 'معاملات نقد به نسیه'; } ?></option>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group form-floating-label">
                                    <input class="form-control input-solid" id="code"   type="number" value="<?=get_new_journal_code()?>"
                                    required readonly >
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                ...
                                <span class="input-group-text" style="width:40px !important;" data-mddatetimepicker="true" data-trigger="click"
                                    ...
                                    data-targetselector="#exampleInput00"  value="<?=$journal[0]['inserted_short_date']?>" required
                            ...
                            <!-- second row (حساب رسیدگی) -->
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <span class="typing-effect" id="from_account_label"></span>
                                        <select  class="form-control select2 " style="width: 100%; border:none !important; background-color:#ddd;" aria-hidden="true" name="from_account_id" id="from_account_id" required > 
                                            <option value="<?=$journal[0]['account_id']?>"><?=$journal[0]['account_name']?></option>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group form-floating-label">
                                        ...
                                        <select  class="form-control select2 " style="width: 100%; border:none !important; background-color:#ddd;" aria-hidden="true" name="to_account_id" id="to_account_id" required > 
                                            <option value="<?=$journal[1]['account_id']?>"><?=$journal[1]['account_name']?></option>
                                ...
                                <div class="col-6">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group form-floating-label">
                                                <input class="form-control input-solid" id="from_amount" name="from_amount" type="text" step="0.01"  value="<?=$journal[0]['amount']?>"   required  oninput="updateToAmountWithThisValue(this.value)" >
                                         ...
                                         <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group form-floating-label">
                                                ...
                                                <option value="<?=$journal[1]['currency']?>"><?=$journal[1]['currency_name']?></option>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group form-floating-label ">
                                        <input class="form-control input-solid" id="from_details" name="from_details" type="text"  placeholder="تفصیلات حساب رسیدگی" required value="<?=$journal[0]['details']?>">
                               ...
                               <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group form-floating-label ">
                                        <input class="form-control input-solid" id="to_details" name="to_details" type="text" placeholder="تفصیلات حساب بردگی" required value="<?=$journal[1]['details']?>" >
