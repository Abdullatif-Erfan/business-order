    ...
    <div class="row">
        ...
        $cards = [
            ...
            [
                ...
                'bgColor' => '#dbf3ff',
                'textColor' => '#3f7cc7',
                'title' => __('dashboard.sales_income'),
            ...
            [
                ...
                'bgColor' => '#dbf3ff',
                'textColor' => '#3f7cc7',
                'title' => __('dashboard.sales_talabat'),
            ...
            [
                ...
                'bgColor' => '#dbf3ff',
                'textColor' => '#3f7cc7',
                'title' => __('dashboard.sales_profit'),
            ...
            [
                ...
                'bgColor' => '#ebd997',
                'textColor' => '#3f7cc7',
                'title' => __('dashboard.trans_expense'),
            ...
            [
                ...
                'bgColor' => '#83d31a',
                'textColor' => '#fff',
                'title' => __('dashboard.khazana_income'),
            ...
            [
                ...
                'bgColor' => '#d3b33b',
                'textColor' => '#fff',
                'title' => __('dashboard.khazana_outcome'),
