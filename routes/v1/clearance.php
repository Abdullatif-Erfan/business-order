...
Route::prefix('clearance')->group(function(){
    ...
    ->name('clearance.buy.create');
    Route::post('/buy/store', [ClearanceController::class, 'store_for_buy'])->name('clearance.buy.store');


    // Sales Clearance
    Route::get('/sales',[ClearanceController::class, 'sales_index'])->name('clearance.sales.index');
    ...
    ->name('clearance.sales.create');
    Route::post('/sales/store', [ClearanceController::class, 'store_for_sales'])->name('clearance.sales.store');
