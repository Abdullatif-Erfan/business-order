                    ...
                    <div class="card" style="overflow: hidden; box-shadow: 0 2px 20px rgba(0,0,0,0.06);">
                        ...
                        <div class="d-flex align-items-center justify-content-between no-print button-wrapper">
                            <ul class="order-tabs no-print" style="border-bottom: none; padding: 0; margin: 0;">
                                <li>
                                    <a class="tab-link active" data-tab="0" href="{{ route('draftOrders.index') }}">
                                        <i class="fas fa-file-alt hidden-xs"></i> {{ __('order.draft') }}
                                    </a>
                                </li>
                                <li>
                                    <a class="tab-link" data-tab="1" href="{{ route('orders.index') }}">
                                        <i class="fas fa-clock  hidden-xs"></i> {{ __('order.order') }}
                                    </a>
                                </li>
                            </ul>
                            <div class="d-flex align-items-center gap-2" style="gap: 4px;">
                                <a href="{{ route('draftOrders.create') }}" class="btn btn-sm no-print" style="background: #3990e7; border: none; color: #fff; border-radius: 5px; padding: 4px 8px;">
                                    <i class="fas fa-plus"></i> <span class="hidden-xs">{{ __('order.add_new_draft_order') }}</span>
                                </a>
                        ...
                        <div class="filter-section no-print" id="searchWrapper">
                            <div class="filter-group">
                                <input type="text" id="item_name" placeholder="{{ __('buy.item') }}" class="form-control">
                            </div>
                            <div class="filter-group">
                                <input type="text" id="customer_name" placeholder="{{ __('order.customer') }}" class="form-control">
                            </div>
                ...
                <form id="stateUpdateForm">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="state" id="state_status">
                            <option value="1">{{ __('order.new') }}</option>
                            <option value="3">{{ __('order.pending') }}</option>
