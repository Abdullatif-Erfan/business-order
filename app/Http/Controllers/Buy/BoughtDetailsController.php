...
class BoughtDetailsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('buy.bought.create',compact('currencies','customers','todaysDate','ownBanks','preLists','units','warehouses','times'));
    }
    ...
    */
    public function store(Request $request)
    {
        ...
        $BoughtItemId = $this->createBoughtItem($request, $newJournalCode, $short_date, $branch_id, $times);
    ...
    private function storeWarehouseItems2($request, $short_date, $item_name, $times)
    {
        $date = explode('-', $short_date);
        $year = $date[0];
        $month = $date[1];
