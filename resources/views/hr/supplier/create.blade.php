                    ...
                    <div class="card">
                        <div class="card-header" style="padding: 10px; text-align:center;">
                            ...
                            <span class="card-title pull-right"> 
                               ایجاد تهیه کننده جدید
                            </span>
                        </div>

                        <div class="card-body">
                            <div class="col-12">
                                <form action="{{ route('supplier.store') }}" method="POST" id="customerForm">
                                    @csrf
                                    <div class="col-xs-12">
                                        <div class="row">

                                            <!-- Account Type (Hidden or Selected) -->
                                                ...
                                                <select class="form-control" name="account_type_id" id="account_type_id" required>
                                                    ...
                                                    @foreach($accountTypes as $accountType)
                                                        <option value="{{ $accountType->id }}" 
                                                            {{ old('account_type_id', $selectedType ?? 3) == $accountType->id ? 'selected' : '' }}>
                                                            {{ $accountType->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group col-sm-4" id="phoneGroup">
                                                ...
                                                <input type="text" class="form-control" name="phone" value="{{ old('phone') }}" placeholder="{{__('common.phone')}} ...">
                                            ...
                                            <div class="form-group col-sm-4" id="addressGroup">
                                                ...
                                                <input type="text" class="form-control" name="address" value="{{ old('address') }}" placeholder="{{__('common.address')}} ...">
                                            ...
                                            <div class="form-group col-sm-4" id="loanLimitGroup">
                                                ...
                                                <input type="number" step="any" class="form-control" name="loan_limit" value="{{ old('loan_limit', 0) }}">
                                            ...
                                            <div class="form-group col-sm-4" id="loanLimitOptionGroup">
                                                ...
                                                <select class="form-control" name="loan_limit_option">
                                                    <option value="0" {{ old('loan_limit_option') == 0 ? 'selected' : '' }}>{{__('settings.no')}}</option>
                                                    <option value="1" {{ old('loan_limit_option') == 1 ? 'selected' : '' }}>{{__('settings.yes')}}</option>
                                                </select>
                                            ...
                                            <div class="col-md-6 m-t-30 m-b-30">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <a href="{{ route('supplier.index') }}" class="btn bg-danger" style="width:100%;">
                                                            {{__('common.cancel')}}
                                                        </a>
                                                    </div>
                                                </div>
