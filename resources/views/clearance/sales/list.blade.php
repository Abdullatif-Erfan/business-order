...
<div class="modal fade" id="salesModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <input type="hidden" id="clearanceRoute" value="{{ route('clearance.sales.create', ['currency_id' => '__currency__', 'sales_to_account_id' => '__account__']) }}">
...
@include('clearance.sales.scripts')
@endsection
