                    ...
                    <table id="example" class="table table-bordered table-striped table-hover" style="width:100%">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2" style="width:15%">حسابات</th>
                                <th colspan="4">  <center>الی امروز </center></th>
                                <th><center>مجموع حسابات</center></th>
                                <th><center> تشخیص</center></th>
                            </tr>
                            <tr>
                                <th style="border-top: 1px solid #fff !important;"><center>بردگی نقد</center></th>
                                <th style="border-top: 1px solid #fff !important;"><center>رسیدگی نقد</center></th>
                                <th style="border-top: 1px solid #fff !important;"><center> بردگی قرض</center></th>
                                <th style="border-top: 1px solid #fff !important;"><center>رسیدگی قرض</center></th>
                                <th style="border-top: 1px solid #fff !important;"><center>بیلانس طلب و قرض</center></th>
                                <th style="border-top: 1px solid #fff !important;"><center>تشخیص</center></th>
                            ...
                            <tbody>
                                ...
                                {
                                    /**
                                     * 1: سال گذشته چقدر قرض دار بودی و چقدر طلب بودی
                                     * 2: امسال چقدر قرض دار هستی و چقدر طلب هستی 
                                     * 3: بیلانس  = (قرض گذشته + قرض امسال) - (طلب سال گذشته + طلب امسال)
                                     */
                                    $final_total = floatval($value['cur_year_payed_loan']) - floatval($value['cur_year_recieved_loan']);
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$value['cur_year_recieved_cache']?> </td>
                                        <td><?=$value['cur_year_payed_cache']?></td>
                                        <td><?=$value['cur_year_recieved_loan']?></td>
                                        <td><?=$value['cur_year_payed_loan']?></td>

                                        <td><?=number_format($final_total,2)?></td>
                                        <td><?= floatval($final_total) == 0 ? 'تصفیه': (floatval($final_total) > 0 ? $value["name"].' طلب است ': $value["name"].' باقی است ') ?></td>
                            ...
                            <tfoot>
                                <tr style="background:#eefcff">
                                    <td colspan="6">مجموع</td>
                                     <td><?=number_format($final_result,2)?></td>
                                     <td>
