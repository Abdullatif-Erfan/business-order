...
class BoughtItem extends Model
{
    ...
    protected $fillable = ['billno','factor','journal_code', 'total_price', 'total_vat', 'cur_pay', 'remained', 'account_id','supplier_account_id','currency_id','tax_activation', 'note', 'idate', 'year', 'month', 'day','times', 'has_invoice', 'invoice_id',
    'user_id','user_name'];
