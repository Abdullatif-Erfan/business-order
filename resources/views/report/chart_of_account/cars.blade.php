<div class="panel-heading m-t-10" style="background-color:#f0eded">
    <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseCar" class="custom-heading">
             {{__('reports.cars')}}  
        </a>
    </h4>
</div>
<div id="collapseCar" class="panel-collapse collapse in" style="height: auto;">
<div class="panel-body" id="body">       
    ...
    <table class="table table-bordered" style="min-width:400px">
        ...
        @foreach($car_accounts as $index => $row)
        @php
